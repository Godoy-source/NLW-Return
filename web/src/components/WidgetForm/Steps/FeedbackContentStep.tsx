...
interface FeedbackContentStepProps {
  ...
  onFeedbackSent: () => void;
  restartFeedbacks: () => void;
}

export function FeedbackContentStep({ feedbackType, restartFeedbacks, onFeedbackSent }: FeedbackContentStepProps) {
    ...
    <>
      ...
      <form className="my-4 w-full" onSubmit={handleSubmitFeedback}>
        <textarea
          ...
          placeholder="Conte com detalhes o seu BUG"
